...
public class Statik {
	...
	// p in 0.005 - Schritten von 1.0 bis 0.005. Angegeben ist jeweils der x-Wert, �ber dem zu liegen die Wahrscheinlichkeit p ist.
	...
	// Werte f�r 0.05 - Power der Chiquadrat - Verteilungen
...
//	public static double logResult;
	...
	public static int vergleich(String eins, String zwei)
	{
		...
		while ((pos1<len1) && (pos2<len2))
		{
			...
			if (c1=='�') c1 = 'a'; if (c1=='�') c1 = 'o'; if (c1=='�') c1 = 'u';
			...
			if (c2=='�') c2 = 'a'; if (c2=='�') c2 = 'o'; if (c2=='�') c2 = 'u';
	...
	*/
	...
	{
		String s = ersetzeString(in, "�", ""+(char)352);
		s = ersetzeString(s, "�", ""+(char)353);
		s = ersetzeString(s, "�", ""+(char)376);
	//	s = ersetzeString(s, "�", ""+(char)354);
		s = ersetzeString(s, "�", ""+(char)167);
		s = ersetzeString(s, "�", ""+(char)8364);
		s = ersetzeString(s, "�", ""+(char)8230);
		s = ersetzeString(s, "�", ""+(char)8224);
		return s;
	}
...
//  funktioniert auch in situ, einfach beiden Argumenten den selben Pointer �bergeben
...
*/
    ...
    // Gibt einen t-Wert zur�ck, so dass die Wahrscheinlichkeit, dass eine Standardnormalverteilung �ber
    ...
    public static double generalDegreeTwoNormalDensity(double a, double b, double c, double x)
    {
        ...
        // die zweite Bedingung besagt, dass der Wurzelinhalt bei 0 selber negativ ist (d.h. wir k�nnen nicht von 0 ausgehen). Ist beides
        // erf�llt, suchen wir zun�chst die Nullstellen und gehen von diesen aus. 
...
//	    System.out.println(matrixToString(mat));
    ...
    */
     ...
     // R�ckgabe ist Vector mit den Eigenwerten.
...
//         System.out.println("Hessenberg Transform ok = "+s);
  ...
  // Ben�tigt ein Feld mit Quadratwurzeln.
...
//                      System.out.println("total transform correct = "+test);
    ...
    /**
      ...
      // Zur�ckgegeben wird H' = Q*this*Q.transpose()
      // Algorithmus nach "Numerical Recipes In Fortran 77: The Art of Scientific Computing" ISBN 0-521-43064-X)
    
      // ist transformationMatrix nicht null, wird Q mit dieser Matrix multipliziert. Ist die Matrix gr��er als Q, wird an Q
       * rechts unten eine Einheitsmatrix hinzugef�gt. 
       * 
       * Zeil und spalt sind nur Arbeitspl�tze und k�nnen null sein.
     */
     ...
     public static double[][] getNextHessenbergOfQR(double[][] matrix, int start, int end, double[][] erg, double[][] transformation, double[] spalt, double[] zeil)
     {
         ...
         for (int i=1; i<=dim-1; i++)
         {
             ...
             // spalt * zeil repr�sentiert die 3x3 Matrix P_i an den Zeilen und Spalten i,i+1,i+2
             double ps = p+s;
